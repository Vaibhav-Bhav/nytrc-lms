  ...
  return (
    <AuthLayout>
      <div>
        ...
        <h1 className="text-2xl font-semibold text-foreground mb-1">Payment confirmed</h1>
        <p className="text-muted-foreground text-sm mb-6">Order #LB-2025-1047</p>
        <div className="bg-muted/50 rounded-xl px-5 py-4 mb-5 border border-border">
        ...
        <div className="flex items-start gap-3 px-4 py-3.5 bg-primary/5 dark:bg-primary/10 rounded-xl border border-primary/15 mb-6">
          ...
          <p className="text-sm text-foreground leading-relaxed">
            ...
            <strong className="font-semibold">sarah.chen@example.com</strong>.{" "}
