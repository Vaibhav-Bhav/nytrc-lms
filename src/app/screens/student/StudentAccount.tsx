      ...
      <main className="flex-1 p-4 sm:p-6 max-w-3xl mx-auto w-full">
        ...
        <div className="bg-card rounded-xl border border-border shadow-sm mb-6">
          ...
          <div className="px-5 sm:px-6 py-5 flex items-center justify-between gap-4">
            ...
            <span className="text-xs px-2.5 py-1 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 font-medium rounded-full flex items-center gap-1">
        ...
        {/* ACTIVE DEVICE SESSIONS SECTION (REQUIRED) */}
            ...
            {loadingSessions ? (
              ...
              <div className="flex flex-col gap-4">
                {sessions.map((device, index) => (
                  <div
                    key={device.id}
                    className="p-4 rounded-xl border border-border bg-card/50 hover:bg-card transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-4"
                  >
                    <div className="flex items-start sm:items-center gap-3.5 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-2 flex-wrap mb-1">
                          ...
                          <span
                            className={cn(
                              ...
                              device.status === "active" ? "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400" : "bg-muted text-muted-foreground"
                            )}
                          >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-0.5 text-xs text-muted-foreground">
                          <p>
                            <span className="font-medium text-foreground">Browser Name:</span> {device.browser}
                          </p>
                          <p>
                            <span className="font-medium text-foreground">Operating System:</span> {device.os}
                          </p>
                          <p>
                            <span className="font-medium text-foreground">Login Time:</span> {device.login_time}
                          </p>
                          <p>
                            <span className="font-medium text-foreground">Last Active Time:</span> {device.last_active || device.lastActive}
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="pt-2 flex flex-col sm:flex-row items-center justify-between gap-3 border-t border-border mt-2">
        ...
        <div className="bg-card rounded-xl border border-border shadow-sm">
          <div className="px-5 sm:px-6 py-4 border-b border-border">
            <h2 className="font-semibold text-foreground">Past invoices</h2>
          </div>
