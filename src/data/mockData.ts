...
export const PAYMENT_HISTORY: PaymentInvoice[] = [
  { id: "inv-001", date: "2024-11-03", amount: "₹14,750", status: "paid", invoice: "INV-2024-001" },
  { id: "inv-000", date: "2024-10-01", amount: "₹0.00", status: "refunded", invoice: "INV-2024-000" },
];
...
export const DEVICE_SESSIONS: DeviceSession[] = [
  { id: "d1", name: "Chrome on MacBook Pro", location: "Mumbai, Maharashtra", lastActive: "Just now", current: true, type: "desktop" },
  { id: "d2", name: "Safari on iPhone 15", location: "Mumbai, Maharashtra", lastActive: "3 hours ago", current: false, type: "mobile" },
  { id: "d3", name: "Chrome on Windows PC", location: "Delhi, India", lastActive: "2 days ago", current: false, type: "desktop" },
];
